...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Siddhant Atole - IT Diploma Student",
    description: `First-year Information Technology diploma student passionate about web development.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://siddhant-atole.vercel.app${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://siddhant-atole.vercel.app${router.asPath}`}
        />
        ...
        <meta name="twitter:site" content="@siddhant_atole" />
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Siddhant Atole. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
